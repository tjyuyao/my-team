...
**Date:** 2026-08-18
**Kind:** plan
**Phase:** v0.11→v1.0（跨版本架构线；P0 为 v0.11 核心交付，P1/P2 属 v1.0+）
...
**与版本计划的关系**：扩展表面是跨版本架构线（不是版本里程碑）。
P0 七任务 = v0.11 的核心交付（见 `2026-08-18-v0.11.0-plan.md`，
场景包被其 gate）；P1/P2（自进化风险分级、多 Deployment、embedding
等）属 v1.0+，不在任何当前版本计划内。
