# My-Team 多智能体协作框架设计 Spec（legacy 备份）

> **本文件为 v0.11 重构前的旧骨架备份（2026-08-24）**：设计权威已
> 迁移至 `SPEC.md`（三态重构版）。**v0.11 及更早的 KANBAN 文件引用
> 本节编号（如 §4.1/§5.2/§6.1）时，见本文件**；v0.12 及以后的
> KANBAN 文件引用新 `SPEC.md` 编号。本文件内容冻结，不再更新。

**版本:** v0.9.0 目标架构（legacy）
